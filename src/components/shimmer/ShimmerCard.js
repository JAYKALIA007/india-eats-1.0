...
const ShimmerCard = () => {
  return (
    <div data-testid='shimmer-card' className='w-[90%] sm:w-[45%] md:w-[38%] lg:w-[30%] xl:w-72 2xl:w-80 lg:h-96 p-2 my-6 mx-auto  md:mx-10 lg:mx-4 xl:mx-auto shadow-sm rounded-md block ' >
